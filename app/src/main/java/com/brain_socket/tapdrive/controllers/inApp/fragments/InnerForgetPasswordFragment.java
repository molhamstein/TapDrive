...
public class InnerForgetPasswordFragment extends Fragment {
    ...
    public static InnerForgetPasswordFragment newInstance(int screenType) {
        InnerForgetPasswordFragment fragment = new InnerForgetPasswordFragment();
